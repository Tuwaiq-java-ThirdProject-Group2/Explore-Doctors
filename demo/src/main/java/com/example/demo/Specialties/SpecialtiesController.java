...
public class SpecialtiesController {
    ...
    @Autowired
    public SpecialtiesController(SpecialtiesServies specialtiesServies) {
        this.specialtiesServies = specialtiesServies;
    }

    @GetMapping
    private List<Specialties> getSpecialtiess() {
        return specialtiesServies.getSpecialtiess();
    }
    ...
    @PostMapping
    public Specialties createSpecialties(@RequestBody Specialties specialties) {
        return specialtiesServies.createSpecialties(specialties);
    }

    @DeleteMapping("/{id}")
    public void deleteSpecialties(@PathVariable String id) {
        specialtiesServies.deleteSpecialties(id);
    }
